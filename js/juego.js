...
var instrucciones = ["Utilizar las flechas del teclado para armar el rompecabezas", "Ordenar las piezas del rompecabezas hasta obetener la imagen objetivo"];
...
function mostrarInstrucciones(instrucciones) {
    var i;
    for (i = 0; i < instrucciones.length - 1; i++) {
...
function agregarMovimientos(codigoDireccion) {
...
function mostrarCartelGanador() {
    if (chequearSiGano()) alert("Felicitaciones! Completaste el rompecabezas!!");
}
